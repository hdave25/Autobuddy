      ...
      <ImageBackground source={require('./images/background.png')} style={{ width: '100%', height: '100%' }}>
        ...
        <View>
          <LinearGradient colors={['dodgerblue', 'deepskyblue', 'skyblue']} style={styles.header}>
            ...
            <Text style={styles.autobuddy}>My Appointments</Text>
          </LinearGradient>
        </View>
        ...
        <ScrollView>
          <View style={styles.column}>
            <View style={styles.note}>
              ...
              <Text style={styles.notedate}>20-07-2018 | 12:00 PM</Text>
              <Text style={styles.notedate}>Vehicle Name : Honda City</Text>
              <Text style={styles.notedate}>Vehicle ID : 754856</Text>
            ...
            <View style={styles.note}>
              ...
              <Text style={styles.notedate}>19-07-2018 | 10:00 AM</Text>
              <Text style={styles.notedate}>Vehicle Name : Honda City</Text>
              <Text style={styles.notedate}>Vehicle ID : 754856</Text>
              <Text style={styles.notedate}>Request ID : 214548</Text>
              <View style={{ height: 1, backgroundColor: 'black' }}></View>
            ...
            <View style={styles.note}>
              <Text style={[styles.notehead, { color: 'green' }]}>Service Request</Text>
              <Text style={styles.notedate}>18-07-2018 | 03:00 PM</Text>
              <Text style={styles.notedate}>Vehicle Name : Honda City</Text>
              <Text style={styles.notedate}>Vehicle ID : 754856</Text>
              <Text style={styles.notedate}>Request ID : 214548</Text>
              <View style={{ height: 1, backgroundColor: 'black' }}></View>
